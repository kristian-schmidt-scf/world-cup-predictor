...
const STRINGS = {
  en: {
    ...
    runningSim:          'Running…',
    modelFull:           'Full Bayesian',
    modelDC:             'Dixon-Coles',
    modelElo:            'Elo Only',
    compareModels:       'Compare Models',
    comparingModels:     'Comparing…',
    modelDivergenceTitle:'Model Divergence — Winner % by model',
    modelDivergenceDesc: 'Teams where the three models disagree most (sorted by spread).',
    colSpread:           'Spread',
    bracketTree:         'Tree',
    bracketTable:        'Table',
    ...
    fantasyBuilder:          'Squad Builder',
    fantasyMyTeam:           'My Team',
    fantasyOptimise:         'Optimise',
    fantasyNoSquad:          'Add players to your squad to see projections.',
    fantasyTotalXpts:        'Total xPts',
    fantasyBudgetUsed:       'Budget Used',
    fantasyXptsGS:           'xPts (Groups)',
    fantasyXptsKO:           'xPts (Knockout)',
    fantasyXptsTotal:        'xPts Total',
    fantasyCaptain:          'Captain',
    fantasyVsOptimal:        'vs Best',
    fantasyChipsTitle:       'Chips & Boosters',
    fantasyChipComingSoon:   'Coming soon',
    fantasyOptimiseHelp:     'Find the highest-projected 15-player squad within the $100M budget.',
    fantasyFindBestXI:       'Find Best Squad',
    fantasyOptimisedBanner:  '✦ OPTIMISED SQUAD',
    fantasyLoading:          'Loading players…',
    fthPos:                  'Pos',
    fthTeam:                 'Team',
    fthName:                 'Player',
    fthPrice:                'Price',
    ...
    fantasyToastCountry:     (team) => `Max 3 players per country (${team})`,
    fantasyToastDuplicate:   'Player already in squad',
    fantasyClearSquad:       'Clear all',
    fantasyAllPos:           'All',
    fantasySearchPlaceholder:'Search player…',
    fantasyMaxPrice:         'Max price',
    fantasyPitchEmpty:       'Your pitch will appear here',
    fantasySetCaptain:       'Set C',
    fantasyIsCaptain:        '★ Captain',
  },
  ...
  de: {
    ...
    runningSim:          'Läuft…',
    modelFull:           'Voll-Bayes',
    modelDC:             'Dixon-Coles',
    modelElo:            'Nur Elo',
    compareModels:       'Modelle vergleichen',
    comparingModels:     'Vergleiche…',
    modelDivergenceTitle:'Modell-Divergenz — Siegwahrsch. je Modell',
    modelDivergenceDesc: 'Teams mit den größten Unterschieden zwischen den drei Modellen.',
    colSpread:           'Spread',
    bracketTree:         'Baum',
    ...
    tabFantasy:              'Fantasy',
    fantasyTitle:            'Fantasy XI',
    fantasyBuilder:          'Kaderersteller',
    fantasyMyTeam:           'Mein Team',
    fantasyOptimise:         'Optimieren',
    fantasyNoSquad:          'Spieler auswählen, um Projektionen zu sehen.',
    fantasyTotalXpts:        'Gesamt xPkt',
    fantasyBudgetUsed:       'Budget verwendet',
    fantasyXptsGS:           'xPkt (Gruppe)',
    fantasyXptsKO:           'xPkt (K.O.)',
    fantasyXptsTotal:        'xPkt Gesamt',
    fantasyCaptain:          'Kapitän',
    fantasyVsOptimal:        'vs. Bestes',
    fantasyChipsTitle:       'Chips & Joker',
    fantasyChipComingSoon:   'Demnächst',
    fantasyOptimiseHelp:     'Besten 15-Spieler-Kader im $100M-Budget finden.',
    fantasyFindBestXI:       'Besten Kader finden',
    fantasyOptimisedBanner:  '✦ OPTIMIERTER KADER',
    fantasyLoading:          'Spieler werden geladen…',
    fthPos:                  'Pos',
    fthTeam:                 'Team',
    fthName:                 'Spieler',
    fthPrice:                'Preis',
    ...
    fantasyToastCountry:     (team) => `Max. 3 Spieler pro Land (${team})`,
    fantasyToastDuplicate:   'Spieler bereits im Kader',
    fantasyClearSquad:       'Alles löschen',
    fantasyAllPos:           'Alle',
    fantasySearchPlaceholder:'Spieler suchen…',
    fantasyMaxPrice:         'Max. Preis',
    fantasyPitchEmpty:       'Hier erscheint dein Spielfeld',
    fantasySetCaptain:       'Kap.',
    fantasyIsCaptain:        '★ Kapitän',
  },
};
