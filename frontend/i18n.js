...
const STRINGS = {
  en: {
    ...
    bcGroupThird:      '3rd',
    bcGroupFourth:     '4th',
    bcThirdsTitle:     'Pick 8 Third-Place Qualifiers',
    bcThirdsDesc:      n => `${n}/8 selected — choose which 8 of the 12 third-placed teams advance to the Round of 32.`,
  ...
  de: {
    ...
    bcGroupThird:      '3.',
    bcGroupFourth:     '4.',
    bcThirdsTitle:     '8 Drittplatzierte auswählen',
    bcThirdsDesc:      n => `${n}/8 ausgewählt — wähle, welche 8 der 12 Drittplatzierten ins Achtelfinale einziehen.`,
